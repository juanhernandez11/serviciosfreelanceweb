    ...
    <section className="py-20 md:py-32 bg-white dark:bg-slate-950">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="hidden md:grid md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8 mb-16">
          {steps.map((step, index) => (
            <div key={index} className="relative group">
              ...
              <div className="relative bg-slate-50 dark:bg-slate-800 rounded-3xl p-8 border-2 border-slate-100 dark:border-slate-700 hover:border-indigo-200 dark:hover:border-indigo-500 transition-all hover:shadow-xl group-hover:-translate-y-2 duration-300">
                ...
                <div className="absolute top-6 right-6 text-6xl font-black text-slate-100 dark:text-slate-700 group-hover:text-indigo-50 dark:group-hover:text-indigo-900 transition-colors">
                  {step.number}
                </div>
                
                <h3 className="text-2xl font-black text-slate-900 dark:text-white mb-3 relative z-10">{step.title}</h3>
        ...
        <div className="md:hidden space-y-6 mb-12">
          {steps.map((step, index) => (
            <div key={index} className="relative">
              ...
              <div className="relative bg-slate-50 dark:bg-slate-800 rounded-3xl p-6 border-2 border-slate-100 dark:border-slate-700">
                <div className="flex items-start gap-4 mb-4">
                  ...
                  <div className="flex-1">
                    <div className="text-4xl font-black text-slate-100 dark:text-slate-700 mb-2">{step.number}</div>
                    <h3 className="text-xl font-black text-slate-900 dark:text-white">{step.title}</h3>
                  </div>
                </div>
                
                <p className="text-slate-600 dark:text-slate-300 text-sm leading-relaxed mb-4 pl-20">{step.description}</p>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
          <div className="bg-emerald-50 dark:bg-emerald-900/20 border-2 border-emerald-100 dark:border-emerald-800 rounded-2xl p-6 sm:p-8">
            <CheckCircle className="text-emerald-600 mb-4" size={32} />
            <h4 className="font-black text-lg sm:text-xl text-slate-900 dark:text-white mb-2">Entregas a tiempo</h4>
            <p className="text-sm text-slate-600 dark:text-slate-300">Cumplimos con los plazos acordados o tu dinero de vuelta</p>
          </div>
          
          <div className="bg-blue-50 dark:bg-blue-900/20 border-2 border-blue-100 dark:border-blue-800 rounded-2xl p-6 sm:p-8">
            <CheckCircle className="text-blue-600 mb-4" size={32} />
            <h4 className="font-black text-lg sm:text-xl text-slate-900 dark:text-white mb-2">Soporte incluido</h4>
            <p className="text-sm text-slate-600 dark:text-slate-300">30 días de soporte técnico post-lanzamiento sin costo</p>
          </div>
          
          <div className="bg-indigo-50 dark:bg-indigo-900/20 border-2 border-indigo-100 dark:border-indigo-800 rounded-2xl p-6 sm:p-8 sm:col-span-2 lg:col-span-1">
            <CheckCircle className="text-indigo-600 mb-4" size={32} />
            <h4 className="font-black text-lg sm:text-xl text-slate-900 dark:text-white mb-2">Código de calidad</h4>
            <p className="text-sm text-slate-600 dark:text-slate-300">Documentación completa y código limpio garantizado</p>
          </div>
        </div>
      </div>
    </section>
